module.exports = {
    ...
    calcularDescontoFaixa: function (faixas) {
        const totalFaixa = parseFloat(faixas.fimFaixa) - parseFloat(faixas.inicioFaixa) * parseFloat(faixas.aliquota)
        return(parseFloat(totalFaixa))
    },
